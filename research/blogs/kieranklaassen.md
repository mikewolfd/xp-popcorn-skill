...
│                 ├─────────────────┤
│                 │    Worker 3     │
└─âsession):** Creates a new tmux session called `claude-swarm`
```bash
...
| Wor dying unexpectedly | Outside tmux, leader exited | Use tmux for persistence |
...
// === CREATE PIPELINE ===
TaskCreate({ subject: "Research OAuth providerscription: "Research OAuth2 best practices and compare providers (Google, GitHub, Auth0)", activeForm: "Researching OAuth..." })
