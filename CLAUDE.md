...
- `shared/skill-sources/templates.md` contains teammate prompt templates (driver, navigator, advisor) that the lead includes when spawning agents. This is the detailed version; `shared/skill-sources/README.md` is the transport-agnostic core and the protocol skill is the condensed version auto-loaded into agents.
