...
**Not in scope here:** generated per-project subagent definitions with bundled hooks, MCP bus, or Codex-specific runtime guarantees (see [dual-mode-codex-companion.md](./dual-mode-codex-companion.md)).
