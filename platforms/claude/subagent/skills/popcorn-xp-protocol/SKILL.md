...
This skill is the canonical protocol source for the Claude package. `shared/protocol/core.md` holds the shared core notes, and `shared/protocol/templates.md` is the lead-facing reference material.
